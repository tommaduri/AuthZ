...
// Phase 1-2 engine (legacy)
pub mod engine_legacy;
pub use engine_legacy::AuthzEngine;
...
pub use scope::{Scope, ScopeResolver, ScopeError, CacheStats as ScopeCacheStats};

// Phase 3 exports
pub use engine::{
    PolicyEngine, EngineConfig,
    AuthRequest, AuthDecision, DecisionReason,
    RequestPrincipal, RequestResource, RequestAction,
    DecisionCache, CacheConfig,
    MetricsCollector, EngineMetrics,
};

#[cfg(feature = "postgres")]
pub use engine::{AuditLogger, AuditEntry};
